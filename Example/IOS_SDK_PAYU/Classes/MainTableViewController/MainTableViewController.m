...
-(void)payWithALU{
    ...
    ALUProduct *product=[[ALUProduct alloc] initALUProductWithName:@"Phone" code:@"12" price:[NSNumber numberWithInt:1] qty:1 currency:NONE];
    ALUProduct *product2=[[ALUProduct alloc] initALUProductWithName:@"Phone2" code:@"12" price:[NSNumber numberWithInt:1] qty:1 currency:NONE];;
    ...
    //данные карты
    alu.CARDINFO=[[ALUCardInfo alloc] initWithCC_NUMBER:@"4272290014182679" EXP_MONTH:@"01" EXP_YEAR:@"2017" CC_CVV:@"099" CC_OWNER:@"Maxim"];
    ...
    alu.TESTORDER=YES;
     ...
     [alu sendALURequstWithResult:^(NSString *response, NSError *error) {
     //результат запроса
     if (response) {
     
     UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:response delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
     [alert show];
