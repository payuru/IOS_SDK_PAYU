...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/IOS_SDK_PAYU'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Max' => 'ixotdog@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/IOS_SDK_PAYU.git', :tag => s.version.to_s }
