...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/payuru/IOS-SDK.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Max Melikhov' => 'ixotdog@gmail.com' }
  s.source           = { :git => 'https://github.com/payuru/IOS-SDK.git', :tag => s.version.to_s }
